...
\setCJKmonofont{Code New Roman Nerd Font Complete Mono.otf} % for \texttt
\setCJKsansfont{SourceHanSansSC-Regular.otf} % for \textsf
...
\author[]{汇报人\quad 朱家政 \\导师 \qquad 宋佳}
%\mail{\emph zhujiazheng@chd.edu.cn}
\institute[IGSNRR·CAS]{\large 中国科学院地理科学与资源研究所\\ \large Institute of Geographic Sciences and Natural Resources Reserarch,CAS}
\date{\today}
\titlegraphic[width=3cm]{logo/igsnrr.png}{}  % 在首页显示校徽
%===================================================================
%===================================================================
\begin{document}
